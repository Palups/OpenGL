...
/**
 * Classe responsável em carregar os shaders no disco.
 * Também tem as funcionalidades:
 * compila e linka os shaders,
 * armazena o ID do shader gerado,
 * faz o bind do shader,
 * define os atributos do shader a partir do seu nome,
 * fornece metodos.
 *
 */
public class Shader {
    ...
    /**
     * Localizao uniforme pelo nome
     * @param name nome do uniforme que será procurado
     * @return Uniforme caso for encontrado
     */
